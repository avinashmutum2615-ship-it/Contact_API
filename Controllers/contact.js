...
export const deleteContactById = async (req,res)=>{
    ...
    if(!deleteContact) return res.json({message:"No Contact Exists", success:false})

        res.json({message:"Contact Delete Successfully....!", success:true})
}
...
export const getContactById = async (req,res) => {
    ...
    if(!userContact) return req.json({message:"No contact found"})
